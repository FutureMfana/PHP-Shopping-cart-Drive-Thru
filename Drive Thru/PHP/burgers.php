<?php
    ...
    $sql_st = "SELECT * FROM burger WHERE qty > 0";
    ...
    while($row = $dataset->fetch_assoc())
    {
        ...
        echo '
            <div class="card col-md-2">
                <form method="post" action="burgers.php?action=add&id='.$row['name'].'">
                    <img src="../IMG/burger/'. $row['img_url'] .'" class="item-img card-img-top" alt="'. $row['name'] .'">
                    <div class="card-body">
                            ...
                            foreach($_SESSION["shopping_cart"] as $keys => $values)
                            {
                                ...
                                echo'
                                    <tr>
                                        ...
                                        <td><a href="burgers.php?action=delete&id='. $values["item"] .'"><span class="text-danger">Remove</span></a></td>
                                    </tr>
                                ';
